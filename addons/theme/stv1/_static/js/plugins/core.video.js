		...
		createDiv:function(){
			...
			$.get(U('public/Feed/videoBox'), {}, function (res) {
					...
					if(res.weibo_uploadvideo_open==1){
						...
						online_html += '<div id="video_online"><div class="video_txt">请输入<a href="http://www.youku.com" target="_blank">优酷</a>、<a href="http://www.tudou.com" target="_blank">土豆</a>、<a href="http://www.yinyuetai.com/" target="_blank">音悦台</a>播放页的链接, “分享->flash地址”</div><div class="video-box" id="video_content"><input type="text" style="width: 320px;" id="videourl" class="s-txt left"/><input type="button" onclick="core.video.video_add();" value="添加" class="btn-add-video"/></div></div>';
					}else{
						tab += '互联网视频';
						online_html += '<div id="video_online"><div class="video_txt">请输入<a href="http://www.youku.com" target="_blank">优酷</a>、<a href="http://www.tudou.com" target="_blank">土豆</a>、<a href="http://www.yinyuetai.com/" target="_blank">音悦台</a>播放页的链接, “分享->flash地址</div><div class="video-box" id="video_content"><input type="text" style="width: 320px;" id="videourl" class="s-txt left"/><input type="button" onclick="core.video.video_add();" value="添加" class="btn-add-video"/></div></div>';
					}
                    console.log(upload_html)
					var html =  '<div class="talkPop alL share_adds" id="videos" style="*padding-top:20px;">\
									<div class="wrap-layer">\
										<div class="arrow arrow-t"></div>\
											<div class="talkPop_box" style="width:450px;" id="talkPop_box_video">\
												<div class="close hd"><a onclick="core.video.removeDiv()" class="ico-close" href="javascript:;" title="'+L('PUBLIC_CLOSE')+'"></a><span>'+tab+'</span></div>'+upload_html+''+online_html+'</div>\
									</div></div>';
					// 插入到body底部
					$('body').append(html);
